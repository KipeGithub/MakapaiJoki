        ...
        <div class="row">
            <div class="col-md">
                <div class="card">
                    ...
                    @endif
                    <form role="form" method="POST" action="{{ route('atsmessage.store') }}"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="filling-time-input" class="form-control-label">Filled By <span
                                                class="text-danger">*</span></label>
                                        <input class="form-control" id="filled-by-input" name="filled-by-input">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="free-text-ats-input" class="form-control-label">Free Text ATS <span
                                                class="text-danger">*</span></label>
