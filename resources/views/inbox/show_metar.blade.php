                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="issued" value="{{ $message->issued }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="observed" value="{{ $message->observed }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="filled_by-input" class="form-control-label">filled_by<span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="filled_by" value="{{ $message->filled_by }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
