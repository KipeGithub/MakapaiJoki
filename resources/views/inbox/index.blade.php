        ...
        <div class="row mt-4 mx-4" >
            <div class="col-12">
                <div class="alert alert-light" role="alert">
                    Fitur ini berfungsi untuk <strong> melihat pesan (message) yang masuk </strong> dari user/ bandara diluar anda.
                </div>
                <div class="container card mb-4">
                    <div class="row">
                        <div class="col-8 card-header">
                            <h6 class="align-middle mb-0">DAFTAR PESAN MASUK (INBOX) </h6>
                        </div>
                    </div>
                    <div class="card-body px-0 pt-0 pb-2">
                        ...
                        @endif
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">Pengirim</th>
                                ...
                                <tbody>
                                    ...
                                    @endphp
                                    <tr>
                                        <td><p class="text-xxs text-center font-weight-bold mb-0">{{ $message->from_username }}</p></td>
                                        <td><p class="text-xxs text-center font-weight-bold mb-0">{{ $message->type }}</p></td>                                    
                                        <td><p class="text-xxs text-center font-weight-bold mb-0">{{ $message->filling_time }}</p></td>                                    
