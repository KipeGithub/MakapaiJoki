...
<div class="container-fluid py-4">
    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="role" value="{{ old('role', auth()->user()->role) }}" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md">
            <div class="card">
                <form role="form" method="POST" action={{ route('profile.update_pw') }} enctype="multipart/form-data">
                    @csrf
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
                            <p class="mb-0">Rubah Password</p>
                            <button type="submit" class="btn btn-primary btn-sm ms-auto">Save</button>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label for="password_new" class="form-control-label">Password Baru</label>
