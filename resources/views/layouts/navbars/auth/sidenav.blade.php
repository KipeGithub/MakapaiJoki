...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 fixed-start"
    ...
    <div class= "w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'usermgt') == true ? 'active' : '' }}" href="{{ route('usermgt.index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'atsmessage') == true ? 'active' : '' }}" href="{{ route('atsmessage.index')}}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'fpl') == true ? 'active' : '' }}" href="{{ route('fpl.index')}}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <hr>
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'notam') == true ? 'active' : '' }}" href="{{ route('notam.index')}}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'meteo') == true ? 'active' : '' }}" href="{{ route('meteo.index')}}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <hr>
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'inbox') == true ? 'active' : '' }}" href="{{ route('inbox.index')}}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-bullet-list-67 text-dark text-sm opacity-10"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'searchmessage') == true ? 'active' : '' }}" href="{{ route('outbox.index')}}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-bullet-list-67 text-dark text-sm opacity-10"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'maintenance') == true ? 'active' : '' }}" href="{{ route('maintenance.index')}}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-bullet-list-67 text-dark text-sm opacity-10"></i>
                    </div>
