...
@section('content')
<<<<<<< HEAD @include('layouts.navbars.auth.topnav', ['title'=> 'Your Profile'])
                                    ...
                                    <div class="row gx-4">
                                        <h4>Sender Identity</h1>
                                            <div class="col-auto">
                                                ...
                                                >>>>>>> a0b50b5b2b3f92fb9e8f8e8b0c54af4ed8b0fc80
                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        <input class="form-control" type="text" name="message_series_0" value="NOTAMN" readonly>
                                                                        <input class="form-control" type="text" name="message_series_1" value="{{ old('message_series.1') }}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        <input class="form-control" type="text" name="number_0" value="{{ old('number.0') }}">
                                                                        <input class="form-control" type="number" name="number_1" value="{{ old('number.1') }}" min="0">
                                                                        <input class="form-control" type="text" name="number_2" value="{{ old('number.2') }}">
                                                                        <input class="form-control" type="text" name="number_3" value="{{ old('number.3') }}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text" name="identified" value="{{ old('identified') }}" style="width: 100%;">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label for="fir-input" class="form-control-label">FIR:<span class="text-danger">*</span></label>
                                                                    <input class="form-control" type="text" name="fir" value="{{ old('fir') }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        <input class="form-control" type="text" name="notam_code_0" value="{{ old('notam_code.0') }}">
                                                                        <input class="form-control" type="text" name="notam_code_1" value="{{ old('notam_code.1') }}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text" name="traffic" value="{{ old('traffic') }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text" name="scope" value="{{ old('scope') }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label for="lower-limit-input" class="form-control-label">Lower Limit:<span class="text-danger">*</span></label>
                                                                    <input class="form-control" type="text" name="lower_limit" value="{{ old('lower_limit') }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label for="upper-limit-input" class="form-control-label">Upper Limit:<span class="text-danger">*</span></label>
                                                                    <input class="form-control" type="text" name="upper_limit" value="{{ old('upper_limit') }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text" name="coordinates" value="{{ old('coordinates') }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        <input class="form-control" type="text" name="location_0" value="{{ old('location.0') }}">
                                                                        <input class="form-control" type="text" name="location_1" value="{{ old('location.1') }}">
                                                                        <input class="form-control" type="text" name="location_2" value="{{ old('location.2') }}">
                                                                        <input class="form-control" type="text" name="location_3" value="{{ old('location.3') }}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="datetime-local" id="YYMMDDhhmm" name="fYYMMDDhhmm" value="{{ now() }}" readonly>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="number-input" class="form-control-label">(EST/PERM)<span class="text-danger">*</span></label>
                                                                    <input class="form-control" type="number" name="estperm" value="{{ old('number.1') }}" min="0">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="time-schedule-input" class="form-control-label">Time
                                                                        Schedule:<span class="text-danger">*</span></label>
                                                                    <input class="form-control" type="text" name="time_schedule" value="{{ old('time_schedule') }}">
                                                                </div>
                                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="message-series-input" class="form-control-label">Message Series:<span class="text-danger">*</span></label>
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <input class="form-control" type="text" name="message_series_0" value="{{ old('message_series.0') }}" style="width: 30%;">
                                                                    <input class="form-control" type="text" name="message_series_1" value="{{ old('message_series.1') }}" style="width: 30%;">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="number-input" class="form-control-label">Number:<span class="text-danger">*</span></label>
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <input class="form-control" type="text" name="number_0" value="{{ old('number.0') }}" style="width: 30%;">
                                                                    <input class="form-control" type="number" name="number_1" value="{{ old('number.1') }}" min="0" style="width: 30%;">
                                                                    <input class="form-control" type="text" name="number_2" value="{{ old('number.2') }}" style="width: 30%;">
                                                                    <input class="form-control" type="text" name="number_3" value="{{ old('number.3') }}" style="width: 30%;">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="identified-input" class="form-control-label">Identified:<span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="fir-input" class="form-control-label">FIR:<span class="text-danger">*</span></label>
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <input class="form-control" type="text" name="fir" value="{{ old('fir') }}" style="width: 30%;">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="notam-code-input" class="form-control-label">Notam Code:<span class="text-danger">*</span></label>
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <input class="form-control" type="text" name="notam_code_0" value="{{ old('notam_code.0') }}" style="width: 30%;">
                                                                    <input class="form-control" type="text" name="notam_code_1" value="{{ old('notam_code.1') }}" style="width: 30%;">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="traffic-input" class="form-control-label">Traffic:<span class="text-danger">*</span></label>
                                                                <input class="form-control" type="text" name="traffic" value="{{ old('traffic') }}" style="width: 30%;">
                                                                <label for="purpose-input" class="form-control-label">Purpose:<span class="text-danger">*</span></label>
                                                                <input class="form-control" type="text" name="purpose" value="{{ old('purpose') }}" style="width: 30%;">
                                                                <label for="scope-input" class="form-control-label">Scope:<span class="text-danger">*</span></label>
                                                                <input class="form-control" type="text" name="scope" value="{{ old('scope') }}" style="width: 30%;">
                                                                <label for="lower-limit-input" class="form-control-label">Lower Limit:<span class="text-danger">*</span></label>
                                                                <input class="form-control" type="text" name="lower_limit" value="{{ old('lower_limit') }}" style="width: 30%;">
                                                                <label for="upper-limit-input" class="form-control-label">Upper Limit:<span class="text-danger">*</span></label>
                                                                <input class="form-control" type="text" name="upper_limit" value="{{ old('upper_limit') }}" style="width: 30%;">
                                                                <label for="coordinates-input" class="form-control-label">Coordinates:<span class="text-danger">*</span></label>
                                                                <input class="form-control" type="text" name="coordinates" value="{{ old('coordinates') }}" style="width: 30%;">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="location-input" class="form-control-label">Location:<span class="text-danger">*</span></label>
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <input class="form-control" type="text" name="location_0" value="{{ old('location.0') }}" style="width: 25%;">
                                                                    <input class="form-control" type="text" name="location_1" value="{{ old('location.1') }}" style="width: 25%;">
                                                                    <input class="form-control" type="text" name="location_2" value="{{ old('location.2') }}" style="width: 25%;">
                                                                    <input class="form-control" type="text" name="location_3" value="{{ old('location.3') }}" style="width: 25%;">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="from-input" class="form-control-label">From:<span class="text-danger">*</span></label>
                                                                <input class="form-control" type="text" name="from" value="{{ old('from') }}" style="width: 50%;">
                                                                <label for="to-input" class="form-control-label">To:<span class="text-danger">*</span></label>
                                                                <input class="form-control" type="text" name="to" value="{{ old('to') }}" style="width: 50%;">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="YYMMDDhhmm" class="form-control-label">YYMMDDhhmm<span class="text-danger">*</span></label>
                                                                <input class="form-control" type="datetime-local" id="YYMMDDhhmm" name="fYYMMDDhhmm" value="{{ now() }}" readonly>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="number-input" class="form-control-label">(EST/PERM)<span class="text-danger">*</span></label>
                                                                <input class="form-control" type="number" name="estperm" value="{{ old('number.1') }}" min="0" style="width: 30%;">
                                                            </div>
                                                            <div class="form-group">
