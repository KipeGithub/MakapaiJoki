                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text" name="message_type" value="FPL" style="width: 100%;" readonly>
                                                                </div>
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="form-control-label">Code, Flight Rules, Type of Flight<span class="text-danger">*</span></label>
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        <div class="form-check form-check-inline" style="width: 10%;">
                                                                            <input class="form-check-input" type="checkbox" name="ssr_mode" value="ssr_mode" id="ssr_mode" {{ is_array(old('ssr_mode')) && in_array('ssr_mode', old('ssr_mode')) ? 'checked' : '' }}>
                                                                            <label class="form-check-label" for="ssr_mode">SSR Mode</label>
                                                                        </div>
                                                                        <input class="form-control" name="ssr_code" value="{{ old('ssr_code') }}" type="number" placeholder="Code" style="width: 30%;">
                                                ...
                                                value="{{ old('type_of_flight') }}" placeholder="Type of Flight"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        <input class="form-control" type="number" name="wake_turb_cat" value="{{ old('wake_turb_cat') }}" placeholder="Wake Turb Cat">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        <input class="form-control" type="text" name="equipment_1" value="{{ old('equipment_1') }}" placeholder="">
                                                                        <div>/</div>
                                                                        <input class="form-control" type="text" name="equipment_2" value="{{ old('equipment_2') }}" placeholder="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
