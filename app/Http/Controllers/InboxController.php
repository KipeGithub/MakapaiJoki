...
class InboxController extends Controller
{
    ...
    public function index()
    {
        ...
        $atsMessages = DB::table('a_t_smessages')
            ...
            ->where('a_t_smessages.to_user_id', $userId);
        ...
        $fplMessages = DB::table('f_p_l_s')
            ...
            ->where('f_p_l_s.to_user_id', $userId);
        ...
        $metarMessages = DB::table('meteos')
            ...
            ->where('meteos.to_user_id', $userId);
        ...
        $notamMessages = DB::table('notams')
            ...
            ->where('notams.to_user_id', $userId);
        ...
        return view('inbox.index', ['messages' => $allMessages]);
    }
